...
Description: The ultimate tool for creating highly attractive optins and email capture forms on your website to increase converions.
Author: PluginOps
...
flush_rewrite_rules();
    ...
    update_option('msfpluginops_prem_plugin_ver', 1.2);
