...
function pluginopsOptinWidgetRender(this_widget){
  ...
  if (optinID != '' && optinID != 'Select') {
    var shortCodeContent = '<div id="" title="Optin Widget" style="text-align:center; font-size:15px; padding:5px 0; width:100%; background:#afafaf; color:#fff; "> <i class="fa fa-check" style="color:#3ae841;"></i> <p> The Optin will be rendered on front end of page. </p> </div>';
  }else{
    var shortCodeContent = '<div class=" '+shortCodeContainerUniqueId+'">  </div>';
    var shortCodeContent = '<div id="" title="Optin Widget" style="text-align:center; font-size:15px; padding:5px 0; width:100%; background:#afafaf; color:#fff; ">  <i class="fa fa-times" style="color:#f44336;" ></i> <p> Please edit this widget & select the Optin from dropdown list. </p> </div>';
  }
...
function formBuilderWidgetRender(this_widget, j, this_column, rowID, this_column_type ){
  ...
  pbFormBuilderSubmit = greCaptchaFieldRender + '<div style="text-align:'+widgetPbFbFormSubmitOptions['formBuilderBtnAlignment']+';  width:'+(widgetPbFbFormSubmitOptions['formBuilderBtnWidth']-parseInt(formBuilderBtnHGap) )+'%; margin:'+buttonMargin+'; margin-right:'+formBuilderBtnHGap+'%; margin-top:'+formBuilderBtnVGap+'%;  display:inline-block;">  <button  style="'+pbFormBuilderSubmitStyles+'" class="pbField-'+widgetPbFbFormSubmitOptions['formBuilderBtnSize']+' pbFieldBtn  form-btn-'+pbFormBuilderUniqueIdBtn+'" disabled="disabled"> '+btnTextWrapped+' </button> </div>';
...
function navigationBuilderWidgetRender(this_widget, j , rowID,this_column,this_column_type){
  ...
  var responsiveMenuSwitch = '<div class="responsiveNavBtn responsiveNavBtninActive" style=" cursor:pointer;"> <i class=" fa fa-navicon "> </i> </div>  <div class="responsiveNavBtn responsiveNavBtnActive" style=" cursor:pointer;"> <i class=" fa fa-navicon "> </i> </div> ';

  var containerLayout = '';
  hideNavIfResposiveActive = 'none';
  var menuLinkGap = " margin: "+allNavStyles['cnslg']+"px 0 ; ";
  if (allNavStyles['cnslayout'] == "Horizontal") { var containerLayout = "display:inline-block;"; var menuLinkGap = " margin:2px "+allNavStyles['cnslg']+"px; "  } else{
  ...
  if (allNavStyles['cnslourl'] != '') {
    var logoImg = ' <div class="cMenuLogoContainer" style="'+containerLayout+'"> <img src="'+allNavStyles['cnslourl']+'"> </div>';
  }
  ...
  var customNavScript = " "+ 
    "<script type='text/javascript'>"+
                    ...
                    "jQuery('.responsiveBtn').live('click',function(){"+
                      "if (jQuery(this).hasClass('rbt-l') ) { "+
                        "$('#"+pbCustomId+" .responsiveNavBtnActive').css('display','none');"+
                        "$('#"+pbCustomId+" .responsiveNavBtninActive').css('display','none');"+
                        "$('#"+pbCustomId+" .menuItemListContainer').show();"+
                        "$('#"+pbCustomId+" .menuItemListContainer').css('display','inline-block');"+
                        "$('#"+pbCustomId+"  ul li .alink ').css('font-size','"+allNavStyles['cnsfs']+"px');"+
                      "}"+
                    "});"+
                    ...
                    "jQuery('.responsiveBtn').live('click',function(){"+
                      "if (jQuery(this).hasClass('rbt-m') ) { "+
                        "$('.responsiveNavBtnActive').css('display','inline-block');"+
                        "$('#"+pbCustomId+" .menuItemListContainer').css('display','"+hideNavIfResposiveActive+"');"+
                        "$('#"+pbCustomId+"  ul li .alink ').css('font-size','"+allNavStyles['cnsfst']+"px');"+
                      "}"+
                    "});"+
                    ...
                    "jQuery('.responsiveBtn').live('click',function(){"+
                      "if (jQuery(this).hasClass('rbt-s') ) { "+
                        "$('.responsiveNavBtnActive').css('display','inline-block');"+
                        "$('#"+pbCustomId+" .menuItemListContainer').css('display','"+hideNavIfResposiveActive+"');"+
                        "$('#"+pbCustomId+"  ul li .alink ').css('font-size','"+allNavStyles['cnsfsm']+"px');"+
                      "}"+
                    "});"+
  ...
  var wholeNavigationContainer = "<div id='"+pbCustomId+"' class='customNavBuilderWidget' style='align-items: center; display: flex; justify-content: center; '> "+logoImg+thisCustomNav+" </div>" + customStyles;
...
function imageGalleryWidgetRender( this_widget, j , rowID,this_column,this_column_type ){
  ...
  gridResponsiveDefault = " <script> "+
      ...
      "jQuery('.responsiveBtn').live('click',function(){"+
        "if (jQuery(this).hasClass('rbt-l') ) { "+
          "$('.po-grid-item_"+uniqueGallId+"').css('width',' "+( parseFloat( allGalleryStyles['wgGC']) - wgGCG_percentage )+"%');"+
        "}"+
      "});"+
  ...
  gridResponsiveTablet = " <script> "+
      ...
      "jQuery('.responsiveBtn').live('click',function(){"+
        "if (jQuery(this).hasClass('rbt-m') ) { "+
          "$('.po-grid-item_"+uniqueGallId+"').css('width','"+( parseFloat( allGalleryStyles['wgGCT']) - wgGCG_percentage )+"%');"+
        "}"+
      "});"+
  ...
  gridResponsiveMobile = " <script> "+
      ...
      "jQuery('.responsiveBtn').live('click',function(){"+
        "if (jQuery(this).hasClass('rbt-s') ) { "+
          "$('.po-grid-item_"+uniqueGallId+"').css('width','"+( parseFloat( allGalleryStyles['wgGCM']) - wgGCG_percentage )+"%');"+
        "}"+
      "});"+
...
function completeWidgetRender(this_column_widgets_array_C, j, this_column, rowID, thisColFontsToLoad){
          ...
          switch (this_column_type) {
            case 'wigt-WYSIWYG':
              ...
              var this_column_editor_content =  " <div class='wltControls' style='display:none;'></div> <div class='liveTextWrap liveText-"+j+" ' data-colInd='"+this_column+"' data-rowId='"+rowID+"'> <span contenteditable='true' class='eltEditable' > <span class='elLtWrapped defaultELt'> " +this_column_editor['widgetContent']+ ' </span>  <div class="ltwFontScript" style="display:none;"> '+this_column_editor['widgetContentFonts']+' </div> </span> </div> ';
            ...
            case 'wigt-pb-cards':
              ...
              this_column_content = cardWidgetRender(this_widget_card, j, rowID,this_column,this_column_type);
              allResponsiveScripts = allResponsiveScripts + this_column_content['WidgetScript'];
              this_column_content = this_column_content['WidgetHtml'];
            break; 
            case 'wigt-pb-testimonial':
              var this_widget_testimonial = this_column_widgets_array_current['widgetTestimonial'];
              this_column_content = testimonialWidgetRender(this_widget_testimonial, j, this_column ,this_column_type, rowID);
              allResponsiveScripts = allResponsiveScripts + this_column_content['WidgetScript'];
              this_column_content = this_column_content['WidgetHtml'];
            break;
            ...
            case 'wigt-pb-pricing':
              ...
              this_column_content = pricingWidgetRender(this_widget_pricing,  j, rowID, this_column_type,this_column);
              allResponsiveScripts = allResponsiveScripts + this_column_content['WidgetScript'];
              this_column_content = this_column_content['WidgetHtml'];
            break;
            ...
            case 'wigt-pb-anchor':
              ...
              this_widgetAnchorHTML = '<div id="'+this_widgetAnchor['wdtanchorid']+'" title="Anchor Widget" style="text-align:center; font-size:15px; padding:5px 0; width:100%; background:#e3e3e3; color:#fff; "> <i class="fa fa-anchor"></i>  </div>';
            ...
            case 'wigt-pb-text':
              ...
              if (widgetTextTag == 'p') {
                if ( textWidgetContentHTML.includes('h1') || textWidgetContentHTML.includes('h2') || textWidgetContentHTML.includes('h3') || textWidgetContentHTML.includes('h4') || textWidgetContentHTML.includes('h5') || textWidgetContentHTML.includes('h6') ) {
                  widgetTextTag = 'div';
                }
              }
            ...
            case 'wigt-pb-liveText':
              ...
              thisWidget = liveTextWidgetRender(thisWidgetFields, j,  rowID , this_column);
              this_column_content = thisWidget['WidgetHtml'];
            break;
            ...
            case 'wigt-pb-poOptins':
              ...
              this_column_content = pluginopsOptinWidgetRender(this_widget);
              allResponsiveScripts = allResponsiveScripts + this_column_content['WidgetScript'];
              this_column_content = this_column_content['WidgetHtml'];
            break;
            case 'wigt-pb-navmenu':
              var this_widget = this_column_widgets_array_current['widgetNavBuilder'];
              this_column_content = navigationBuilderWidgetRender(this_widget, j , rowID,this_column,this_column_type );
              allResponsiveScripts = allResponsiveScripts + this_column_content['WidgetScript'];
              this_column_content = this_column_content['WidgetHtml'];
            break;
            case 'wigt-pb-gallery':
              var this_widget = this_column_widgets_array_current['widgetIGallery'];
              this_column_content = imageGalleryWidgetRender(this_widget, j , rowID,this_column,this_column_type );
              allResponsiveScripts = allResponsiveScripts + this_column_content['WidgetScript'];
              this_column_content = this_column_content['WidgetHtml'];
            break;
...
function rowColumnSingleRender(thisColumnModelData, rowID ,this_column, rowColumns, rowHeightData ){
        ...
        if (typeof(this_column_options['colBgImg']) !== 'undefined') {
          ...
          if (this_column_bg_img !== '') {
            colBackgroundOptions = 'background-image: url('+this_column_bg_img+') no-repeat center; background-size:cover; background-color:'+this_column_bg_color+';';
          }
        }
