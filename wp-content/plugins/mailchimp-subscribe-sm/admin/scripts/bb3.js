...
/* ----------- Live Text Editor Starts Here -------------- */
  ...
  $('.liveTextWrap').live('click',function(ev){
  ...
  $('.wlt-btn').live('click',function(ev){
  ...
  $('.wltCInput').live('change',function(ev){
