          ...
          $.ajax({
            ...
            success: function(result){
              ...
              var webHookResponse = '<?php echo $this_widget_form_builder['widgetPbFbFormMailChimp']['wfb_cWebHookSuccResponse']; ?>';
                ...
                if (emailResult == 'success' || mcResult == 'success' || grResult == 'success' || cmResult == 'success' || acResult == 'success' || dripResult == 'success' || aweberResult == 'success' || convertkitResult == 'success' || webHookResult == webHookResponse || marketheroResult == 'success' || SendinBlueResult == 'success' || MailPoetResult == 'success' || ConstantContactResult == 'success' ) {
