      ...
      for ($j = 0; $j < count($colWidgets); $j++) {  // widgets loop
          ...
          switch ($this_column_type) {
            case 'wigt-WYSIWYG':
              ...
              $thisWidgetContentEditor =  $this_widget_editor['widgetContent'] . "<div style='display:none;'>".$this_widget_editor['widgetContentFonts']."</div> ";
            ...
            case 'wigt-btn-gen':
              ...
              if (strpos($btnLink, 'http') !== false) {
                  $thisPageLink = get_preview_post_link( $current_pageID );
            ...
            case 'wigt-pb-postSlider':
                ...
                if ($widgetPostsSliderExternalScripts == true) {
                  ...
                  $widget_postsSliderLibrary =  "<script type='text/javascript' src='".SMFB_PLUGIN_URL."/public/scripts/owl-carousel/owl.carousel.js'></script> ";
                }
            ...
            case 'wigt-pb-icons':
                ...
                $widgetIconRender = "<div class='iconContainerDiv iconContainer-".$randomClass." ' style='text-align:center; display:flex; align-items:center; justify-content:center; '  > $pbIconLinkHTMl <i class='$pbSelectedIcon icon-".$randomClass."' style='$widgetIconStyles' ></i> $pbIconLinkHTMlclose </div>".$iconHoverAnimationScript . $hoverStyles;
            ...
            case 'wigt-pb-counter':
                ...
                //if (!function_exists('smfb_available_pro_widgets') ) { $widgetContent = "$premWidgetNotice"; }
            break;
            case 'wigt-pb-audio':
            ...
            case 'wigt-pb-imgCarousel':
              ...
              if ($widgetPostsSliderExternalScripts == true) {
                ...
                echo  "<script type='text/javascript' src='".SMFB_PLUGIN_URL."/public/scripts/owl-carousel/owl.carousel.js'></script> ";
              }
            ...
            case 'wigt-pb-liveText':
                ...
                $widgetLiveContent = "<div>".$widgetTextContent."</div> <div style='display:none;'>".$this_widget_text['wltfs']."</div> ";
            ...
            case 'wigt-pb-navmenu':
                ...
                foreach ($allNavItems as $key => $val) {
                  $thisMenuLink = '<a href="'.$val['cniurl'].'" target="_blank">'.$val['cnilab'].'</a>';
                ...
                if ($allNavStyles['cnslayout'] == "Horizontal") {  
                  ...
                  $listItemHeightwrapped = ' '; $hideMenuIfNotHorizontal = 'display:none;'; 

                  $responsiveMenuSwitch = '<div class="responsiveNavBtn responsiveNavBtninActive" style=" cursor:pointer;"> <i class=" fa fa-navicon "> </i> </div>  <div class="responsiveNavBtn responsiveNavBtnActive" style=" cursor:pointer;"> <i class=" fa fa-navicon "> </i> </div>';
                }
                ...
                if ($allNavStyles['cnslayout'] != "Horizontal") { $responsiveMenuScript = ''; }
                $widgetFALoadScripts = true;
                $wholeNavigationContainer = "<div id='".$pbCustomId."' class='customNavBuilderWidget' style=''> ".$logoImg.$thisCustomNav." </div>" . $customStyles . $responsiveMenuScript;
