...
if (isset($isShortCodeTemplate)) {
  if ($isShortCodeTemplate == true) {
    ...
    echo '<script type="text/javascript" src="'.SMFB_PLUGIN_URL.'/js/jquery.min.js"></script>';
  }
}
?>


<script src="<?php echo SMFB_PLUGIN_URL.'/js/jquery-ui.js'; ?>"></script>
<link rel="stylesheet" type="text/css" href="<?php echo SMFB_PLUGIN_URL.'/js/Backbone-resources/jquery-ui.css'; ?>">
...
<?php include 'style.css'; ?>
  ...
  .ulpb_PageBody<?php echo $current_pageID; ?>{
      ...
      position: relative;
      clear: both;
      <?php if ( $selecteOptinType == 'Full Page'): ?>
